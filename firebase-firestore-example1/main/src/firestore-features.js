...
class FirestoreFeatures  {
    ...
    */
    ...
    /*
      O Cloud Firestore armazena dados nos Documentos que s�o armazenados nas Cole��es. O Cloud Firestore cria cole��es e documentos de modo impl�cito na primeira vez que voc� adiciona dados ao documento. N�o � necess�rio criar cole��es ou documentos explicitamente.
     */
